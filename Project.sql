...
CREATE TABLE IMGS_file (
    IMGS_file_id NUMBER PRIMARY KEY NOT NULL,  -- �̹��� ID
    IMGS_file_data BLOB ,              -- �̹��� ���� ��ü
    IMGS_file_name VARCHAR2(255),     -- �̹��� ���� �̸�
...
CREATE TABLE IMGS_link (
    IMGS_link_id NUMBER PRIMARY KEY NOT NULL,       -- �̹��� ID
    IMGS_link_path VARCHAR2(1500),          -- �̹��� ���� ��� �Ǵ� URL
    IMGS_link_name VARCHAR2(255),          -- �̹��� ���� �̸�
    IMGS_link_upload_date DATE DEFAULT SYSDATE,   -- ���ε� ��¥
