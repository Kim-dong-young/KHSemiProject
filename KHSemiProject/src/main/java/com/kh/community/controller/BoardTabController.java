...
/**
 * Servlet implementation class BoardTabController
 */
public class BoardTabController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int tabNo = Integer.parseInt(request.getParameter("tno"));
		...
		listCount = new BoardService().selectBoardTabListCount(tabNo);
		...
		ArrayList<Board> boardList = new BoardService().selectBoardTabList(tabNo);
