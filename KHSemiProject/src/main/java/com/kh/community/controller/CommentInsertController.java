...
public class CommentInsertController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		System.out.println(userNo);  // O
		System.out.println(content); // O
		System.out.println(communityNo); // O
		
		System.out.println(cpage); // O
		System.out.println(cmtPage); //  X
		*/
		...
		response.sendRedirect("board?cpage="+ cpage +"&no="+ communityNo +"&comment=1");
	}
